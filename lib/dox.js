...
exports.parseComments = function(js, options){
  ...
  for (var i = 0, len = js.length; i < len; ++i) {
    ...
    if (!withinMultiline && !withinSingle && '/' == js[i] && '*' == js[i+1]) {
      ...
      if (js.slice(i + 2, i + 8) == "jshint") skip = true;
      if (js.slice(i + 2, i + 8) == "eshint") skip = true;
      if (js.slice(i + 2, i + 8) == "jslint") skip = true;

      if (options.skipPrefix && js.slice(i + 2).indexOf(options.skipPrefix) != -1)
        skip = true;
